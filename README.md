...
| # | 目录 | 文章 | 配套代码 | 行数 | 核心主题 |
|---|------|------|----------|------|----------|
| 01 | [01-essence/](./01-essence/) | [OpenClaw / Claude Code 的底层原理，只有 115 行](./01-essence/agent-essence.md) | [`agent-essence.py`](./01-essence/agent-essence.py) | 103 行 | 工具 + 循环，Agent 最小实现 |
